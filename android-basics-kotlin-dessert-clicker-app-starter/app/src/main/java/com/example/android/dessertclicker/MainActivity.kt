...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Log class include Log.i() for informational messages, Log.e() for errors,
        // Log.w() for warnings, or Log.v() for verbose messages.
        // The log tag (the first parameter), in this case "MainActivity". The tag is a string that
        // lets you more easily find your log messages in the Logcat. The tag is typically the name of the class.
